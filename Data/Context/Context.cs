...
public class Context : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("server=DEVELOPER1;database=IliaDabirkhane2;user ID=sa;password=12345@Iran;MultipleActiveResultSets=True;TrustServerCertificate=True");
    }
}